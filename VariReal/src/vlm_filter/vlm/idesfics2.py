...
class Idefics2Model:
    def __init__(self, model_name_or_path="HuggingFaceM4/idefics2-8b", device: str = "cuda", cache_dir=None, **kwargs):
        ...
        processor = AutoProcessor.from_pretrained("HuggingFaceM4/idefics2-8b", do_image_splitting=False, cache_dir=cache_dir)
