...
class LlaVaModel:
    def __init__(self, model_name_or_path="llava-hf/llava-v1.6-mistral-7b-hf", device: str = "cuda", load_in_Nbit=None, cache_dir=None):
        ...
        processor = LlavaNextProcessor.from_pretrained(model_name_or_path, cache_dir=cache_dir)
