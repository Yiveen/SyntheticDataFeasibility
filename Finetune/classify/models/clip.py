...
#     @staticmethod
    def tokenize_text(self):
        ...
        iter_label = SUBSET_NAMES[self.dataset]
        print('Current classification classes are:', len(iter_label))
        for classname in iter_label:
...
#         text_feats = einops.rearrange(text_feats, "(c p) d -> c p d", c=n_classes, p=n_prompts)
    ...
    def forward(
        ...
        **kwargs,
        ...
        # print('logits1', image_feats.shape)
        # print('logits2', text_feats.shape)
        ...
        # print('logits', logits_per_image.shape)
